...
function App() {
  ...
  return (
    <header className=' bg-black'>
      ...
      <nav className='wrapper h-20 py-8  flex items-center justify-between '>
      ...
      <section className='z-30' >
        <div className='max-w-[1400px] h-[780px] w-full m-auto py-2 px-4 static md:relative group  z-30'>
